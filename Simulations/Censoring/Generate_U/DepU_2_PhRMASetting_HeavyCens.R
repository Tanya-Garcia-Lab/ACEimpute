...
for (s in 1:num_sim) {
  ...
  write.csv(save_res, "~kylegrosser/Documents/GitHub/Random-Error-Imputation/Simulations/Censoring/Generate_U/Results/DepU_2_PhRMASetting_HeavyCens.csv", row.names = F)
}
